package edu.eafit.HeydiProyect.Services;

import java.util.Date;
import java.util.List;
import java.util.Optional;

import edu.eafit.HeydiProyect.Interfaces.BaseAuthorService;
import edu.eafit.HeydiProyect.Models.Authors;
import edu.eafit.HeydiProyect.repositories.AuthorRepositories;

public class AuthorService implements BaseAuthorService {

    private AuthorRepositories _AuthorRepository;

    public AuthorService(AuthorRepositories _AuthorRepository) {
